											...
											'<div class="panel panel-default">' + 
												'<div class="panel-heading">' +
													'<h4 class="panel-title">' +
														'<a data-toggle="collapse" data-parent="class_all_collapse_'+key+'" href="#class_all_collapse_body_'+key+'">Class ' + num + '  /  Class Name: <b>' + reply[key].class_name + '</b>  /  Class Code: <b>' + reply[key].code + '</b>  /  Class Status: <b>' + reply[key].status + '</b></a>' + 
													' </h4>' +
												'</div>' +
