											...
											'<div class="panel panel-default">' + 
												'<div class="panel-heading">' +
													'<h4 class="panel-title">' +
														'<a data-toggle="collapse" data-parent="exam_record_collapse_'+key+'" href="#exam_record_collapse_body_'+key+'">Exam Record ' + num + '</a>' + 
													' </h4>' +
												'</div>' +
												...
												'<div class="panel-body">' + 
													'<div class="row">' + 
														'<div class="col-xs-3">'+ 
															'<div>Exam Date: ' + reply[key].exam_date + '</div>' +
														'</div>' + 
													'</div>' +
													'<hr>' +  
													'<div class="row">' + 
									...
									target.append(
										'<div class="panel-group" id="ato_collapse_'+key+'">' +
											'<div class="panel panel-default">' + 
												'<div class="panel-heading">' +
													'<h4 class="panel-title">' +
														'<a data-toggle="collapse" data-parent="ato_collapse_'+key+'" href="#ato_collapse_body_'+key+'">ATO ' + num + '</a>' + 
													' </h4>' +
												'</div>' +
